...
ggplot(chomage2020)+geom_boxplot(aes(x=SEXE, y=Hsouhaitées))+ylim(0, 80)+ ggtitle("graphique 13: Nombre d'heures souhaitées par sexe
") +
  xlab("Sexe") + ylab("Nombre d'heures") + align
```
...
[7] Helena Massadier (2020), Le taux de chômage des femmes françaises : un indicateur en trompe-l'oeil, Science Po, Chaire pour l’emploi et l’entrepreuriat des femmes https://www.sciencespo.fr/women-business/fr/actualites/le-taux-de-chomage-des-femmes-francaises-un-indicateur-en-trompe-l-oeil.html 